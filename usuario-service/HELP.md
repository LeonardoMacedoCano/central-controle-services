...
* The original package name 'br.com.lcano.usuario-service' is invalid and this project uses 'br.com.lcano.usuario_service' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/3.4.9/how-to/data-initialization.html#howto.data-initialization.migration-tool.liquibase)
